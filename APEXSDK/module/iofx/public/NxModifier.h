...
public:
	...
	virtual physx::PxF32 getScaleChangeLimit() const = 0;
	/// set the scale change limit
	virtual void setScaleChangeLimit(const physx::PxF32& s) = 0;

	/// get the scale change delay
	virtual physx::PxF32 getScaleChangeDelay() const = 0;
	/// set the scale change delay
	virtual void setScaleChangeDelay(const physx::PxF32& s) = 0;
};
